...
/// <summary>
/// Linux OCR stub. Tesseract integration can be added in a future release.
/// </summary>
public class LinuxOcrService : IOcrService
{
    ...
    public Task<OcrResult> RecognizeAsync(SKBitmap image, OcrOptions options)
    {
        return Task.FromResult(new OcrResult
        {
            Text = string.Empty,
            Success = false,
            ErrorMessage = "OCR is not yet supported on Linux. Tesseract support planned for a future release."
        });
    }
}
